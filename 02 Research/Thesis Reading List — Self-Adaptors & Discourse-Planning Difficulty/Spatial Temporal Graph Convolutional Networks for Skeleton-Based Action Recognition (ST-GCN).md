...
**Research question / methodology.**  spatial-temporal graph convolution over skeleton sequences, learning spatial and temporal patterns automatically. 

**Conclusion.**  the classic, well-understood skeleton baseline -- the honest pose-only anchor before claiming contact-graph or Transformer gains.