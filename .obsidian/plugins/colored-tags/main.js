...
`);
  ...
  buildTagSelectors(tagName) {
    ...
    const selectors = [
      ...
      `.metadata-property[data-property-type="tags" i] .multi-select-pill.colored-tag-${tagLower}`,
      `.metadata-property .multi-select-pill.colored-tag-${tagLower}`,
  ...
  buildRemoveButtonSelectors(tagName) {
    ...
    return tagLower ? [
      ...
      `.metadata-property[data-property-type="tags" i] .multi-select-pill-remove-button.colored-tag-${tagLower}`,
      `.metadata-property .multi-select-pill-remove-button.colored-tag-${tagLower}`,
